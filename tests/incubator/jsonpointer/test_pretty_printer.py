...
class TestPPDict(unittest.TestCase):
    def test_empty_dict(self) -> None:
        lines = [""]
...
class TestPrettyPrint(unittest.TestCase):
    ...
    def test_list(self) -> None:
        expected = "[\n  1,\n  2,\n  3\n]"
        actual = pretty_print([1, 2, 3], FormatFlags().with_single_line(False))
        self.assertEqual(actual, expected)
        
        expected = "[ 1, 2, 3 ]"
        actual = pretty_print([1, 2, 3], FormatFlags().with_single_line(True))
        self.assertEqual(actual, expected)

    def test_dict(self) -> None:
        expected = "{\n  key1: value1,\n  key2: value2\n}"
        actual = pretty_print({"key1": "value1", "key2": "value2"}, FormatFlags().with_single_line(False))
        self.assertEqual( actual, expected )
        
        expected =  "{ key1: value1, key2: value2 }"
        actual = pretty_print({"key1": "value1", "key2": "value2"}, FormatFlags().with_single_line(True))
        self.assertEqual( actual, expected )
    ...
    def test_complex(self) -> None:
        ...
        expected = "{\n  key1: value1,\n  key2:\n  [\n    1,\n    2,\n    3\n  ],\n  key3:\n  {\n    subkey1: subvalue1,\n    subkey2: subvalue2\n  }\n}"
        actual = pretty_print(data, FormatFlags().with_single_line(False))
        self.assertEqual(actual, expected)
    ...
    def test_complex_single_line(self) -> None:
        ...
        actual = pretty_print(data, FormatFlags().with_single_line(True))
        self.assertEqual(actual, expected)

    def test_empty_list(self) -> None:
        expected =  "[ ]"
        actual = pretty_print([], FormatFlags(), [])
        self.assertEqual(actual, expected)
