...
class ParseResult:
    ...
    6. If the happy path is reached, return res.success() with the object (usually a node) to be returned to caller
    ...
    3. Rely on res.register(sub_production()) to propagate errors from deeper levels.
